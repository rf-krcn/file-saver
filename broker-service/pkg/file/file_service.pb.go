...
func (x *AddRequest) GetFileSize() int64 {
	if x != nil {
		return x.FileSize
	}
	return 0
...
func (x *GetContent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetContent) ProtoMessage() {}

func (x *GetContent) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_file_file_service_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetContent.ProtoReflect.Descriptor instead.
func (*GetContent) Descriptor() ([]byte, []int) {
	return file_pkg_file_file_service_proto_rawDescGZIP(), []int{2}
}

func (x *GetContent) GetFileContent() []byte {
	if x != nil {
		return x.FileContent
	}
	return nil
...
type GetResponse struct {
	...
	FileSizeBytes uint64 `protobuf:"varint,3,opt,name=file_size_bytes,json=fileSizeBytes,proto3" json:"file_size_bytes,omitempty"`
	CreatingTime  string `protobuf:"bytes,4,opt,name=creating_time,json=creatingTime,proto3" json:"creating_time,omitempty"`
}
...
func (x *AllFilesResponse) Reset() {
	*x = AllFilesResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_file_file_service_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AllFilesResponse) Descriptor() ([]byte, []int) {
	return file_pkg_file_file_service_proto_rawDescGZIP(), []int{5}
}
...
var file_pkg_file_file_service_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9f, 0x01,
	...
	0x66, 0x69, 0x6c, 0x65, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x18, 0x05, 0x20, 0x01,
	...
	0x09, 0x52, 0x08, 0x66, 0x69, 0x6c, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x2f, 0x0a, 0x0a, 0x47,
	0x65, 0x74, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x12, 0x21, 0x0a, 0x0c, 0x66, 0x69, 0x6c,
	0x65, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52,
	0x0b, 0x66, 0x69, 0x6c, 0x65, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0x42, 0x0a, 0x0a,
	...
	0x22, 0x94, 0x01, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	...
	,
...
var file_pkg_file_file_service_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_pkg_file_file_service_proto_goTypes = []interface{}{
	(*AddRequest)(nil),       // 0: AddRequest
	(*AddResponse)(nil),      // 1: AddResponse
	(*GetContent)(nil),       // 2: GetContent
	(*GetRequest)(nil),       // 3: GetRequest
	(*GetResponse)(nil),      // 4: GetResponse
	(*AllFilesResponse)(nil), // 5: AllFilesResponse
}
var file_pkg_file_file_service_proto_depIdxs = []int32{
	4, // 0: AllFilesResponse.files:type_name -> GetResponse
	0, // 1: FileService.UploadFile:input_type -> AddRequest
	3, // 2: FileService.GetFile:input_type -> GetRequest
	3, // 3: FileService.GetAllFiles:input_type -> GetRequest
	1, // 4: FileService.UploadFile:output_type -> AddResponse
	2, // 5: FileService.GetFile:output_type -> GetContent
	5, // 6: FileService.GetAllFiles:output_type -> AllFilesResponse
...
func file_pkg_file_file_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pkg_file_file_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
